...
if (WIN32)
  ...
  if (NOT glfw3_FOUND AND NOT GLFW3_DIR)
    set(GLFW3_ZIP ${CMAKE_BINARY_DIR}/downloaded_resources/glfw-3.3.1.zip)
    set(GLFW3_DIR ${CMAKE_BINARY_DIR}/downloaded_resources/glfw-3.3.1)
    ...
    if(NOT EXISTS ${GLFW3_DIR}/CMakeLists.txt)
      ...
      execute_process(COMMAND ${CMAKE_COMMAND} -E tar -xf ${GLFW3_ZIP}
              WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/downloaded_resources)
      endif()
	endif()
