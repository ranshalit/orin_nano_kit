...
if (UNIX)
  ...
  if(${COMPILER_REAL_PATH} MATCHES "aarch64")
      # Vulkan SDK is not available in aarch64 architecture, use the prebuilt library/executable
    find_path(VULKANSDK_ROOT_DIR NAMES include/vulkan/vulkan.h 
      HINTS
        ${PROJECT_SOURCE_DIR}/shared_external/VulkanSDK/1.3.239.0/aarch64
        ${PROJECT_SOURCE_DIR}/../shared_external/VulkanSDK/1.3.239.0/aarch64
        ${PROJECT_SOURCE_DIR}/../../shared_external/VulkanSDK/1.3.239.0/arch64
        "$ENV{VULKAN_SDK}"
    )
  else()
    find_path(VULKANSDK_ROOT_DIR NAMES include/vulkan/vulkan.h HINTS "$ENV{VULKAN_SDK}")
  endif()
...
if (VULKANSDK_ROOT_DIR)
  ...
  if (UNIX)
    unset(VULKAN_LIB)
    find_library(VULKAN_LIB NAMES vulkan HINTS "${VULKANSDK_ROOT_DIR}/lib")
